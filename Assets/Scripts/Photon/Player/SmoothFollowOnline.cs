...
[AddComponentMenu("Camera-Control/Smooth Follow Online")]

public class SmoothFollowOnline : MonoBehaviourPun
{
    /*
    ...
    void LateUpdate()
    {
        ...
        if (target.GetComponent<PlayerControlsOnline>().current_gravity == Vector3.down)
        {
        ...
        else if (target.GetComponent<PlayerControlsOnline>().current_gravity == Vector3.right)
        {
        ...
        else if (target.GetComponent<PlayerControlsOnline>().current_gravity == Vector3.up)
        {
        ...
        else if (target.GetComponent<PlayerControlsOnline>().current_gravity == Vector3.left)
        {
