...
public class UserManager2 : MonoBehaviour
{ 
	...
	{
		UserLeaderboard2.LoadLeaderboards(OnGotLeaderboards, OnGotLeaderboardsFailed);
	}
	...
	private void ShowLeaderboard(int boardIndex)
	{
		...
		var script = list.GetComponent<UserList2>();
