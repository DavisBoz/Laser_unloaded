...
public class SmoothFollowLevel1 : MonoBehaviour
{
    /*
    ...
    */
    ...
    void LateUpdate()
    {
        ...
        if (target.GetComponent<PlayerControlsLevel1>().current_gravity == Vector3.down)
        {
        ...
        else if (target.GetComponent<PlayerControlsLevel1>().current_gravity == Vector3.right)
        {
        ...
        else if (target.GetComponent<PlayerControlsLevel1>().current_gravity == Vector3.up)
        {
        ...
        else if (target.GetComponent<PlayerControlsLevel1>().current_gravity == Vector3.left)
        {
